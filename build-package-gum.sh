...
wget -q "https://github.com/${REPO}/releases/download/v${VERSION}/${PACKAGE_NAME}_${VERSION}_amd64.deb"

echo
echo "Downloading arm64 .deb"
wget -q "https://github.com/${REPO}/releases/download/v${VERSION}/${PACKAGE_NAME}_${VERSION}_arm64.deb"
